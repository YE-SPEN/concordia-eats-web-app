			...
			<tbody>
				<tr>
					...
					try {
						...
						ResultSet rs = stmt.executeQuery("SELECT * from users WHERE role = 'ROLE_USER'");
					%>
					<%
					while (rs.next()) {
					%>
					...
					<td>
						<a class="btn btn-info" href="mailto:<%= rs.getString(6) %>" style="background-color: #339933">Contact Customer</a>
					</td>
